...
Modify the MOCK_PROPS object with the data you want to test.
...
Save index.html. The browser will automatically reload with the new props.

Building for Production

When you are ready to build the final JavaScript file for Shopify:
